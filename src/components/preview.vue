...
.box {
  ...
  .card {
    ...
    .cost {
      ...
      padding-left: 26px;
      padding-top: 20px;
      background: url('../assets/cost_bg.png');
    ...
    .evolutionInfo {
      ...
      &-item {
        ...
        margin-left: 16px;
        margin-top: -4px;
        background: url('../assets/evolutionInfo_bg_2.png');
        background-size: cover;
        ...
        &:nth-child(1) {
          ...
          margin-left: 0;
          margin-top: 0;
          background: url('../assets/evolutionInfo_bg_1.png');
        }
    ...
    .card-info {
      ...
      &-number {
        ...
        .kind {
          ...
          width: 36px;
          height: 18px;
          background: url('../assets/kind_bg.png');
          background-size: cover;
          font-family: 'Microsoft YaHei';
          font-size: 14px;
          color: #000000;
